...
pct create $CTID local:vztmpl/$system -cores $core -cpuunits 1024 -memory $memory -swap 128 -rootfs local:${disk} --onboot 1 -password $password -features force_rw_sys=1,password_authentication=1
pct start $CTID
